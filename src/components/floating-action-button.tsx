    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-[56] flex justify-center pb-[calc(5rem+env(safe-area-inset-bottom,0px))] sm:pb-[calc(3.25rem+env(safe-area-inset-bottom,0px))]">
      <div className="sm-app-constrain flex w-full justify-center px-3">
        <button
          ...
          onClick={onClick}
          aria-label={label}
          className="pointer-events-auto flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#3A4254] to-[#4F4A68] text-xl font-light leading-none text-white shadow-md shadow-black/22 transition duration-200 hover:scale-[1.03] active:scale-95 sm:h-14 sm:w-14 sm:text-2xl"
        >
          +
        </button>
      </div>
