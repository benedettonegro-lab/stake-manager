...
export function AppShell({
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#0B1224] text-[#E6EAF2]">
      ...
      <main
        className={`sm-app-constrain flex-1 px-2 pt-1.5 transition-[opacity,transform] duration-200 ease-out motion-reduce:transition-none sm:px-4 sm:pt-4 ${showBottomNav ? "pb-[calc(5.5rem+env(safe-area-inset-bottom,0px))] sm:pb-36" : "pb-6 sm:pb-10"}`}
      >
        {subtitle ? (
